...
## Why conversational ERP

Most ERP investments underperform for one reason: **people don't adopt them.**

* ERP is implemented, but a week later staff are back in Excel — adoption stays near zero.
* Creating one order can take six screens, so teams fall back to Zalo because it's faster. Data becomes scattered and hard to control.
...
* **Natural-language operations** — create orders, check inventory, query revenue, prepare POs.
* **AI prepares, humans decide** — the agent drafts actions (POs, reminders, follow-ups); a user reviews and approves before anything is committed or sent.
* **Works with your existing ERP** — connects via API. No data migration required.
* **Multi-channel** — Web UI and Telegram.
...
* [How it works](introduction/how-it-works.md) — the architecture behind the chat.
* [Getting Started](introduction/getting-started.md) — log in and send your first message.
